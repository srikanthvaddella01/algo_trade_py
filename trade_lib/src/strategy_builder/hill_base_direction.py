            ...
            if instr_day_orders.shape[0] > num_trades:
                ...
                if instr_positional_orders.shape[0] == 0:
                    if current_record_direction != previous_record_direction:
                        ...
                        if current_candle_dict_info['candle_position'] != 'DOWN_OPEN_OUTSIDE_DOWN_CLOSE_OUT_SIDE' and current_record_direction == 'up' and third_record > second_record or current_candle_dict_info['candle_position'] == 'DOWN_OPEN_OUTSIDE_DOWN_CLOSE_OUT_SIDE' and current_record_direction == 'up' and third_record < second_record:
                        ...
                        elif (current_candle_dict_info['candle_position'] == 'DOWN_OPEN_OUTSIDE_DOWN_CLOSE_OUT_SIDE' or current_record_direction != 'up') and (current_candle_dict_info['candle_position'] == 'DOWN_OPEN_OUTSIDE_DOWN_CLOSE_OUT_SIDE' or current_record_direction != 'down' or third_record < second_record) and (current_candle_dict_info['candle_position'] == 'DOWN_OPEN_OUTSIDE_DOWN_CLOSE_OUT_SIDE' or current_record_direction == 'down') and (current_candle_dict_info['candle_position'] != 'DOWN_OPEN_OUTSIDE_DOWN_CLOSE_OUT_SIDE' or current_record_direction != 'up') and (current_candle_dict_info['candle_position'] != 'DOWN_OPEN_OUTSIDE_DOWN_CLOSE_OUT_SIDE' or current_record_direction != 'down' or third_record > second_record) and (current_candle_dict_info['candle_position'] != 'DOWN_OPEN_OUTSIDE_DOWN_CLOSE_OUT_SIDE' or current_record_direction == 'down'):
